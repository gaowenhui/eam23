...
<s:hidden id="getCardInfo"/>
 <table width="100%" border="0" cellpadding="2" cellspacing="0"  class="newtable" align="center"  >
    <tr>
      <td colspan="6" class="td_top" align="center" >投资性土地卡片信息</td>
    </tr>
    <%if(!isCardInfo){ %>
    ...
    <table width="100%" border="0"  cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	 ...
	 <table width="100%" border="0" cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	    <tr>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.synx" maxlength="20" onblur="checkFloat(this)" size="30"/>（年）
	      <%}%></td>
	    </tr>
	    <tr>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.syyx" maxlength="20" onblur="checkFloat(this)" size="30"/>（月）
	      <%}%></td>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.yzje" maxlength="20" onblur="checkFloat(this)" size="30"/>（元）
	      <%}%></td>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.yjtyf" maxlength="20" onblur="checkFloat(this)" size="30"/>（月）
	      <%}%></td>
	    </tr>
	    <tr>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.ljzj" maxlength="20" onblur="checkFloat(this)" size="30"/>（元）
	      <%}%></td>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.jvalue" maxlength="20" onblur="checkFloat(this)" size="30"/>（元）
	      <%}%></td>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.jevalue" maxlength="20" onblur="checkFloat(this)" size="30"/>（元）
	      <%}%></td>
	    </tr>
	    <tr>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.jcz" maxlength="24" onblur="checkFloat(this)" size="30"/>（元）
	      <%}%></td>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.jczl" maxlength="22" onblur="checkPresent(this)" size="30"/>（%）
	      <%}%></td>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.yzjl" maxlength="20" onblur="checkPresent(this)" size="30"/>（%）
	      <%}%></td>
	    </tr>
	</table>
    <table width="100%" border="0"  cellpadding="2" cellspacing="0" align="center"   class="newtable" >
