...
<table width="100%" border="0" cellpadding="2" cellspacing="0"  class="newtable" align="center"  >
    <tr>
      <td colspan="6" class="td_top" align="center" >土地卡片信息</td>
    </tr>
    <%if(!isCardInfo){ %>
    ...
    <table width="100%" border="0"  cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	  ...
	  <table width="100%" border="0" cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	    <tr>
	      ...
	      <td class="td_form02">
	      <%if(isCardModify||isMMergeBody||isCardInfo){%>
    ...
    <table width="100%" border="0"  cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	  ...
	  <table width="100%" border="0" cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	    <tr>
	      ...
	      <%}else{ %>
	      <s:select name="body.qszm" onblur="isString(this);" list="#{'':'',1:'有',0:'无'}"></s:select>
	      <%} %>
	      </td>
