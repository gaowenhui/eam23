...
<table width="100%" border="0" cellpadding="2" cellspacing="0"  class="newtable" align="center"  >
    <tr>
      <td colspan="6" class="td_top" align="center" >经营租入固定资产改良卡片信息</td>
    </tr>
    <%if(!isCardInfo){ %>
    ...
    <tr>
	  ...
	  <%}else{ %>
	  	<s:textfield name="body.ggxh" size="30" onblur="isString(this);"  />
	  <%} %>
	  </td>
    </tr>
    <tr>
      ...
      <%}else if(isCardInfo){ %>
      		<s:textfield name="bodyValue.usestateValue" id='userStatushiddenid'  disabled="true"></s:textfield>
      <%}else{ %>
      		<s:textfield name="bodyValue.usestateValue" id="userStatusvalue" size="30" disabled="true"/>
      		<s:hidden name='body.usestatus' id='userStatushiddenid'></s:hidden>
    ...
    <tr>
      ...
      <%}else{ %>
      	<s:textarea name="body.mainyt" cols="150" rows="4"></s:textarea>
      <%} %>
      </td>
    </tr>
    </table>
    <table width="100%" border="0"  cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	  ...
	  <table width="100%" border="0" cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	    <tr>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.ybyz" id="ybyz" maxlength="20" onblur="checkFloat(this)" size="30"/>（元）
	      <%}%></td>
    ...
    <table width="100%" border="0"  cellpadding="0" cellspacing="0" align="center"   class="newtable" >
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"   class="newtable" >
	    <tr>
	      ...
	      <td class="td_form02">
	      <%if(isCardModify ||isCardInfo){%>
      			<s:textfield name="body.oldcode" onblur="isString(this);" maxlength="20" size="30" disabled="true"/>
	      <%}else{ %>
	      		<s:textfield name="body.oldcode" maxlength="20" size="30"/>
	      <%}%>
	      </td>
