...
<s:hidden id="getCardInfo"/>
 <table width="100%" border="0" cellpadding="2" cellspacing="0"  class="newtable" align="center"  >
    <tr>
      <td colspan="6" class="td_top" align="center" >房屋及建筑物卡片信息</td>
    </tr>
    <%if(!isCardInfo){ %>
	    <!-- YanPeiLing modify  start 2011-1-8 -->
    ...
    <tr>
      ...
      <%}else{ %>
      	<s:textfield name="body.zcname" id="zcname" maxlength="40" onblur="isString(this);" size="30"/>
      <%} %>
      </td>
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	    <tr>
	      ...
	      <td class="td_form02">
	      <%if(isCardModify||isCardInfo){%>
      			<s:textfield name="body.synx" id="synx" maxlength="20" size="30" disabled="true"/>（年）
	      <%}else{ %>
	      		<s:textfield name="body.synx" id="synx" onblur="checkFloat(this);" maxlength="20" size="30"/>（年）
	      <%}%></td>
	    </tr>
	    <tr>
	      ...
	      <td class="td_form02">
	      <%if(isCardModify||isCardInfo){%>
      			<s:textfield name="body.syyx" id="syyx" maxlength="20" size="30" disabled="true"/>（月）
	      <%}else{ %>
	      		<s:textfield name="body.syyx" id="syyx" onblur="checkFloat(this);" maxlength="20" size="30"/>（月）
	      <%}%></td>
	      ...
	      <td class="td_form02">
	      <%if(isCardModify||isCardInfo){%>
      			<s:textfield name="body.yjtyf" id="yjtyf" maxlength="20" size="30" disabled="true"/>（月）
	      <%}else{ %>
	      		<s:textfield name="body.yjtyf" id="yjtyf" onblur="checkFloat(this);" maxlength="20" size="30"/>（月）
	      <%}%></td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	      ...
	      <td class="td_form02">
	      <%if(isCardModify||isMMergeBody||isCardInfo||isMSplitBody){%>
      			<s:textfield name="body.jczl" id="jczl" maxlength="22" size="30" disabled="true"/>（%）
	      <%}else{ %>
	      		<s:textfield name="body.jczl" id="jczl" onblur="checkPresent(this);" maxlength="22" size="30"/>（%）
	      <%}%></td>
	      <td class="td_form01">月折旧率</td>
	      <td class="td_form02">
	      <%if(isCardModify||isMMergeBody||isCardInfo||isMSplitBody){%>
      			<s:textfield name="body.yzjl" id="yzjl"  maxlength="20" size="30" disabled="true"/>（%）
	      <%}else{ %>
	      		<s:textfield name="body.yzjl" id="yzjl" onblur="checkPresent(this);" maxlength="20" size="30"/>（%）
	      <%}%></td>
	    </tr>
	</table>
    <table width="100%" border="0"  cellpadding="2" cellspacing="0" align="center"   class="newtable" >
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	    <tr>
	      ...
	      <td class="td_form01">房产证号码</td>
	      <td class="td_form02">
	      <%if(isCardInfo){ %>
	      	<s:textfield name="body.fdzhm" maxlength="20" size="30" disabled="true"/>
	      <%}else{ %>
	      	<s:textfield name="body.fdzhm" onblur="isString(this);" maxlength="20" size="30"/>
	      <%} %>
	      </td>
	    ...
	    <tr>
	      ...
	      <td class="td_form01">建筑面积</td>
	      <td class="td_form02">
	      <%if(isCardInfo){ %>
	      	<s:textfield name="body.jzmj" maxlength="20" size="30" disabled="true" />平方米
	      <%}else{ %>
	      	<s:textfield name="body.jzmj" onblur="checkFloat(this);" maxlength="20" size="30"/>平方米
	      <%} %>
	      </td>
	      <td class="td_form01">装修面积</td>
	      <td class="td_form02">
	      <%if(isCardInfo){ %>
	      	<s:textfield name="body.zxmj" maxlength="20" size="30" disabled="true" />平方米
	      <%}else{ %>
	      	<s:textfield name="body.zxmj" onblur="checkFloat(this);" maxlength="20" size="30"/>平方米
	      <%} %>
	      </td>
	    </tr>
	    <tr>
	      <td  class="td_form01">有无对应土地</td>
	      <td class="td_form02">
	      <%if(isCardInfo){ %>
	      	<s:select name="body.ywdytd" list="#{'':'',1:'有',0:'无'}" disabled="true" ></s:select>
	      <%}else{ %>
	      	<s:select name="body.ywdytd" list="#{'':'',1:'有',0:'无'}"></s:select>
	      <%} %>
	      </td>
	      <td class="td_form01">对应土地证号</td>
	      <td class="td_form02">
	      <%if(isCardInfo){ %>
	      	<s:textfield name="body.dytdzh" maxlength="150" size="30" disabled="true" />
	      <%}else{ %>
	      	<s:textfield name="body.dytdzh"  maxlength="150" size="30"/>
	      <%} %>
	      </td>
	      <td class="td_form01">对应土地原卡片编号</td>
	      <td class="td_form02">
	      <%if(isCardInfo){ %>
	      	<s:textfield name="body.dytdkp" maxlength="150" size="30" disabled="true"/>
	      <%}else{ %>
	      	<s:textfield name="body.dytdkp" onblur="checkFloat(this);" maxlength="150" size="30"/>
	      <%} %>
	      </td>
	    </tr>
    </table>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"   class="newtable" >
	    <tr>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.oldcode" onblur="checkFloat(this);" maxlength="20" size="30"/>
	      <%}%>
	      </td>
	      <td class="td_form01">评估前原值</td>
	      <td class="td_form02">
	      <%if(isCardInfo){ %>
	      	<s:textfield name="body.pgqyz" id="pgqyz" maxlength="20" size="30" disabled="true" />（元）
	      <%}else{ %>
	      	<s:textfield name="body.pgqyz" id="pgqyz" onblur="checkFloat(this);" maxlength="20" size="30"/>（元）
	      <%} %>
	      </td>
	      ...
	      <%}else{ %>
	      	<s:textfield name="body.pgqljzj" onblur="checkFloat(this);" maxlength="20" size="30"/>（元）
	      <%} %>
	      </td>
	    </tr>
	    <tr>
