...
<s:hidden id="getCardInfo"/>
 <table width="100%" border="0" cellpadding="2" cellspacing="0"  class="newtable" align="center"  >
    <tr>
      <td colspan="6" class="td_top" align="center" >交通运输设备卡片信息</td>
    </tr>
    <%if(!isCardInfo){ %>
    ...
    <tr>
      ...
      <%}else if(isMMergeBody||isMSplitBody){ %>
      		<s:select name="body.state" id="state"  id="state" list="#{'01':'正在使用','02':'空闲状态','03':'退役'}" disabled="true"></s:select>
      <%}else{ %>
      		<s:select name="body.state" id="state"  id="state" list="#{'02':'空闲状态','01':'正在使用','03':'退役'}" disabled="true"></s:select>
      <%}%>	
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="td_form02">
      <%if(isCardInfo){ %>
      <s:textfield name="body.username" id="username" size="30"  disabled="true" />
      <%}else{ %>
      <s:textfield name="body.username" id="username" onblur="isString(this);" size="30" />
      <%} %>
      </td>
    ...
    <table width="100%" border="0"  cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	  ...
	  <table width="100%" border="0" cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	    <tr>
	      ...
	      <td class="td_form02">
	      <%if(isCardInfo){ %>
	        <s:textfield name="body.clpxh" maxlength="150" size="30" disabled="true"/>
	      <%}else{ %>
	        <s:textfield name="body.clpxh" onblur="isString(this);" maxlength="150" size="30"/>
	      <%} %>
	      </td>
	      <td class="td_form01">发动机号码</td>
	      <td class="td_form02">
	      <%if(isCardInfo){ %>
	      	<s:textfield name="body.fdjhm" onblur="isString(this);" disabled="true" maxlength="150" size="30"/>
	      <%}else{ %>
	      	<s:textfield name="body.fdjhm" onblur="isString(this);" maxlength="150" size="30"/>
	      <%} %>
	      </td>
		</tr>
	</table>
