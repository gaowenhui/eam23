...
<table width="100%" border="0" cellpadding="2" cellspacing="0"  class="newtable" align="center"  >
    <tr>
      <td colspan="6" class="td_top" align="center" >投资性房屋卡片信息</td>
    </tr>
    <%if(!isCardInfo){ %>
    ...
    <table width="100%" border="0"  cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	  ...
	  <table width="100%" border="0" cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	    ...
	    <tr>
	      ...
	      <td class="td_form02">
	      <%if(isCardModify||isMMergeBody||isCardInfo||isMSplitBody){%>
      			<s:textfield name="body.yzje" maxlength="20" size="30" disabled="true"/>（元）
	      <%}else{ %>
	      		<s:textfield name="body.yzje" onblur="checkFloat(this);" maxlength="20" size="30"/>（元）
	      <%}%></td>
	    ...
	    <tr>
	      ...
	      <td class="td_form02">
	      <%if(isCardModify||isMMergeBody||isCardInfo||isMSplitBody){%>
      			<s:textfield name="body.ljzj" maxlength="20" size="30" disabled="true"/>（元）
	      <%}else{ %>
	      		<s:textfield name="body.ljzj" onblur="checkFloat(this);" maxlength="20" size="30"/>（元）
	      <%}%></td>
	      <td class="td_form01">净值</td>
	      <td class="td_form02">
	      <%if(isCardModify||isMMergeBody||isCardInfo||isMSplitBody){%>
      			<s:textfield name="body.jvalue" maxlength="20" size="30" disabled="true"/>（元）
	      <%}else{ %>
	      		<s:textfield name="body.jvalue" onblur="checkFloat(this);" maxlength="20" size="30"/>（元）
	      <%}%></td>
	      <td class="td_form01">净额</td>
	      <td class="td_form02">
	      <%if(isCardModify||isMMergeBody||isCardInfo||isMSplitBody){%>
      			<s:textfield name="body.jevalue" maxlength="20" size="30" disabled="true"/>（元）
	      <%}else{ %>
	      		<s:textfield name="body.jevalue" onblur="checkFloat(this);" maxlength="20" size="30"/>（元）
	      <%}%></td>
	    </tr>
	    <tr>
	      ...
	      <td class="td_form02">
	      <%if(isCardModify||isMMergeBody||isCardInfo||isMSplitBody){%>
      			<s:textfield name="body.jcz" maxlength="24" size="30" disabled="true"/>（元）
	      <%}else{ %>
	      		<s:textfield name="body.jcz" onblur="checkFloat(this);" maxlength="24" size="30"/>（元）
	      <%}%></td>
    ...
    <table width="100%" border="0"  cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	  ...
	  <table width="100%" border="0" cellpadding="2" cellspacing="0" align="center"   class="newtable" >
	    ...
	    <tr>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.dytdzh" onblur="isString(this);" maxlength="150" size="30"/>
	      <%}%>
	      </td>
	      ...
	      <%}else{ %>
	      		<s:textfield name="body.dytdkp" onblur="isString(this);" maxlength="150" size="30"/>
	      <%}%>
	      </td>
	    </tr>
	    </table>
    <table width="100%" border="0"  cellpadding="0" cellspacing="0" align="center"   class="newtable" >
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"   class="newtable" >
	    <tr>
	      ...
	      <%}else{ %>
	      	<s:textfield name="body.pgqyz" onblur="checkFloat(this);" maxlength="20" size="30"/>（元）
	      <%} %>
	      </td>
