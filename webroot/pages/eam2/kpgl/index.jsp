    ...
    <body class="easyui-layout">
        <div region="north" title="模块导航" split="true" style="height:110px;background:#B3DFDA;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="385" rowspan="3"><img src="<%=basePath %>resource/ProjectImages/top_r1_c1.jpg" alt="" width="385" height="74" /></td>
              <td width="100%" rowspan="3" background="<%=basePath %>resource/ProjectImages/top_r1_c3.jpg">&nbsp;</td>
              <td width="61" rowspan="3"><img src="<%=basePath %>resource/ProjectImages/top_r1_c7.jpg" alt="" width="76" height="74" /></td>
              <td width="385" background="<%=basePath %>resource/ProjectImages/index_r1_c6.jpg">&nbsp;</td>
            ...
            <tr>
              <td colspan="3"><img src="<%=basePath %>resource/ProjectImages/index_r2_c6.jpg" alt="" width="517" height="18" /></td>
            </tr>
            <tr>
              <td colspan="3" background="<%=basePath %>resource/ProjectImages/index_r3_c26.jpg" bgcolor="#2B8585"><img src="<%=basePath %>resource/ProjectImages/gjtop_r1_c1.jpg" alt="" width="201" height="34" /><img src="resource/ProjectImages/top1.jpg" width="316" height="34" /></td>
            </tr>
          </table>
    </div>
        <div id="west" region="west" split="true" title="  菜单" style="width:200px;padding:10px;">
         ...
         <script type="text/javascript">
            ...
            tree.loadXML("<%=basePath %>menuData.jspa?parid=25");
        </script>

        <div align="center" region="center" title="卡片管理" scrolling="no">
            <%
        	if(urlPortal == null || urlPortal.length() == 0){
	        %>
