		...
		<s:form action="zyzc/ZCManageBody_saveBody.do" name="myform" id="myform">
			...
			<table class="newtable" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="td_zxy02">
						<s:textfield name="body.zcbh"/>
					</td>
					<td class="td_zxy01">序 列 号：</td>
					<td class="td_zxy02">
						<s:textfield name="body.xlh"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="td_zxy02">
						<s:date name="%{#request.body.cbrq}" format="yyyy-MM-dd" var="draftDate1"/>
						<s:textfield name="body.cbrq" id="cbrq" value="%{#draftDate1}" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td_zxy02">
						<s:textfield label="" onblur="checkFloat(this);" name="body.dj" value="%{#request.body.dj}" />
					</td>
					<td class="td_zxy01">金 额：</td>
					<td class="td_zxy02">
						<s:textfield name="body.je" onblur="checkFloat(this);" value="%{#request.body.je}" />
					</td>
				</tr>
				<tr>
					<td class="td_zxy01">新出保日期：</td>
					<td class="td_zxy02">
						<s:date name="%{#request.body.xxbrq}" format="yyyy-MM-dd" var="draftDate"/>
						<s:textfield label="" id="xxbrq" name="body.xxbrq" value="%{#draftDate}" />
					</td>
					<td class="td_zxy01">所属账管：</td>
					<td class="td_zxy02">
						<s:textfield name="body.sszg" />
					</td>
				</tr>
				<tr>
