...
%>
<!-- ==========================  权限控制添加     ======================================== -->
<r:controlfile file="/pages/eam2/zyzc/toCheck/checkstock.ctl.xml"></r:controlfile>
<!-- ================================================================================== -->
...
<html>
	...
	<!-- 	<div style="text-align: right">
		...
		<br/><br/>
		<div align="center">
			<span class="STYLE1">中国建银投资有限责任公司自用资产盘库申请</span>
		</div>
		<!-- ==========================工作流信息项======================================= -->
		...
		<table id="conditions" class="newtable" width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
			  	...
			  	<td class="td_zxy02">
			  		<r:textfield name="head.sheetId" disabled="true" cssClass="input" id="bianhao11"/>
			  	</td>
		...
		<script type="text/javascript">
			jQuery("#assetList").jqGrid({
				...
				datatype:"json",
				colNames:['id','zcId','一级分类','二级分类','三级分类','盘库批次','资产名称',
						  '品牌/规格型号','资产编号','数量','盘点数量','单位','盘库结果'],
				colModel:[	
		...
		<script type="text/javascript">
			...
			function panYing(){
				...
				window.open('<%=request.getContextPath()%>/zyzc/ToCheck_panYing.do?sheettype=tocheckstockadd',
			...
			function modifyBody(){
				...
				if(gr.length > 1){
					...
					var bodyId = gr;
					window.open('<%=request.getContextPath()%>/zyzc/ToCheck_PYPKModify.do?sheettype=tocheckstock'+'&bodyId='+bodyId,
