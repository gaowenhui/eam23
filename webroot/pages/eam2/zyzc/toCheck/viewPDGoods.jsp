		...
		<s:form action="zyzc/ToCheck_saveInfoToPdxx.do" name="myform"  id="myform">
			...
			<table class="newtable" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="td_zxy02">
						<s:textfield  name="pdxx.syrmc" readonly="true" cssClass="input" id="syrmc"/>
					</td>
					<td class="td_zxy01">使用人部门：</td>
					<td class="td_zxy02">
						<s:textfield name="pdxx.sybmbmc" readonly="true" id="sybmbmc" cssClass="input"/>
					</td>
				</tr>
				<tr>
					<td class="td_zxy01">盘点数量：</td>
					<td class="td_zxy02">
						<s:textfield  name="pdxx.pdsl" readonly="true" cssClass="input" id="pdsl"/>
					</td>
					<td class="td_zxy01">盘点结果：</td>
					<td class="td_zxy02">
						<s:textfield name="pdxx.pdjg" readonly="true" id="pdjg" cssClass="input"/>
					</td>
				</tr>
				<tr>
