...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function(){
				//var zcId = "<%=request.getAttribute("zcId")%>";
				...
				if(isSaveSuccess != null && isSaveSuccess != "null" && isSaveSuccess.length > 0){
					...
					window.opener.myform.isSaveSuccess.value = isSaveSuccess;
	...
	<body>
		<s:form action="zyzc/ZCQuery_saveZcInfoToZyZc.do" name="myform"  id="myform">
