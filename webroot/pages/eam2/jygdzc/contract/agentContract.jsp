...
<!-- ==========================  权限控制添加     ======================================== -->
<r:controlfile file="/pages/eam2/jygdzc/contract/agentContract.ctl.xml"></r:controlfile>
<!-- ================================================================================== -->
<%
...
<SCRIPT language=JavaScript type=text/JavaScript>
		  ...
		  <e:pc id="scbh">
	       ...
	       //办结按钮
			<e:pc id="banjie">
				var buttonStr_banjie = '[{"buttonHandler":"mainWindow.liuchengbanjie","buttonIcon":"icon-edit","buttonText":"办结"}]';
		...
		function setValue(inde){
			...
			var sheettype ="";
			 ...
			 url = '<%=request.getContextPath()%>/htqs/ContractManageBody_newBody.do?sheettype='+sheettype+'&bmbh='+bmbh+'&headId='+headId+'&operate=isNewHt';
			 var g_ = 'height=600, width=1000, top=10, left=100, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no';
			 window.open(url,'',g_);
			 //window.open(url);
		}
		 ...
		 var jwlx = document.getElementById('jwlx').value;
			if(jwlx=='0'){
				 ...
				 if("1"==htlx||"2"==htlx){
				 	 ...
				 	 window.open('<%=basePath%>htqs/ContractManageBody_modifyBody.do?sheettype=biandong&view=disabled&headId=${headId}&operate=change&htId='+gr+'&htlx='+htlx,'','height=550, width=1100, top=100, left=100, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no');
				 }
			}else if(jwlx=='1'){
...
<input type="hidden" name="head.lcId" value="合同维护(代理机构)" />
...
<!-- =========================================================================== -->
      <br/>
      <div align="center">
        <span class="STYLE7 STYLE1">中国建银投资有限责任公司合同维护(代理机构)处理单</span>
      </div>
      <br/>
<!-- ==========================工作流信息项======================================= -->
...
<!-- =========================================================================== -->
 ...
 <div id="addToParent" style="display: none;">
        <div id="mm1" style="width:150px;">
            <div onClick="setValue(1);" iconCls="icon-redo">租赁合同</div>
            <div onClick="setValue(2);" iconCls="icon-redo">委管合同</div>
