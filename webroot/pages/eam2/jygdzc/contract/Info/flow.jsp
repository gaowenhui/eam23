...
<script type="text/javascript">
		...
		<script type="text/javascript">
			...
			var title = document.getElementById("title").value;
				...
				url:"<%=basePath%>htqs/ContractManageBody_queryWorkFlow.do?sheettype2=change&htId=${htId}",
...
<body>
<s:hidden name="zcId"  value="%{#request.htId}"/>
...
<table id="endtask_list" align="center" ></table>
		...
		<script type="text/javascript">
		$(function(){
			jQuery("#endtask_list").setGridWidth($("#table").width());
			$(window).bind('resize', function(){
				jQuery("#endtask_list").setGridWidth($("#table").width());
			});
		})
				jQuery("#endtask_list").jqGrid({	
					url:"<%=basePath%>htqs/ContractManageBody_queryWorkFlow.do?sheettype2=change&htId=${htId}&sheettype=${sheettype}",
					datatype: "json",
					mtype:"POST",
