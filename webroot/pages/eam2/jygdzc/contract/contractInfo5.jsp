...
<html>
  ...
  <body>
	...
	<script>
		...
		tabbar.setContentHref("a1","<%=basePath %>htqs/ContractQuery_getDetail.do?htlx=${htlx}&htId=${htId}");
		tabbar.setContentHref("a2","<%=basePath %>htqs/ContractQuery_toView.do?sheettype=changeHistoryInfo&htId=${htId}");
		tabbar.setContentHref("a3","<%=basePath %>htqs/ContractQuery_toView.do?sheettype=liquidateInfo&htId=${htId}");
		tabbar.setContentHref("a4","<%=basePath %>htqs/ContractQuery_flow.do?htId=${htId}");
