			...
			$(window).bind('resize', function(){
				jQuery("#changeHistory").setGridWidth($("#table").width());
                                        ...
                                        jQuery("#changeHistory").jqGrid({
                                          	url:"<%=basePath%>jygdzc/AssetManageBody_query4View.do?spzt=pass&zcId=${zcId}&sheettype=changeHistory&type=change",
											datatype: "json",                                      
											mtype:"POST", 
		    ...
		    $(window).bind('resize', function(){
				jQuery("#xiugailishi").setGridWidth($("#table").width());
                                        ...
                                        jQuery("#xiugailishi").jqGrid({
                                          	url:"<%=basePath%>jygdzc/AssetManageBody_query4View.do?headId=${headId}&zcId=${zcId}&sheettype=${sheettype}",
											datatype: "json",
											mtype:"POST", 
