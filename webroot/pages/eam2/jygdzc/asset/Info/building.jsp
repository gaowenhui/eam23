...
<html>
	...
	$(function(){
  	 $("#jcrq,#qdrq,#fczblsj,#gzwjcsj,#tdzblsj").datebox({
	...
	function savebody(){
		building.action="<%=basePath%>jygdzc/AssetManageBody_saveBody.do?";
		building.submit();
		...
		<s:form method="post" id="building">
			...
			<table width="100%" border="0" class="newtable" cellpadding="2" cellspacing="0"
				...
				<tr>
					...
					<td class="td_form02">
						<s:textfield name="jyzcXxBuilding.zynx"  onblur="checkNumber2(this)"	 id="zynx" 
					...
					<td class="td_form02">
						<s:textfield name="jyzcXxBuilding.sysynx"  onblur="checkNumber2(this)" id="sysynx"
				...
				<tr>
					...
					<td class="td_form02">
						<s:textfield name="jyzcXxBuilding.gzwsl" onblur="checkNumber2(this)" id="gzwsl"
					...
					<td class="td_form02">
						<s:textfield name="jyzcXxBuilding.gzwcbdj" onblur="checkNumber2(this)" id="gzwcbdj"
