...
%>
<r:controlfile file="/pages/eam2/jygdzc/asset/assetCheck.ctl.xml"></r:controlfile>
<!-- ================================================================================== -->
  ...
  $(document).ready(function(){	
		  ...
		  function delete_asset(){
			...
			function add_asset(){
			   var headId = document.getElementById("headId").value;
				window.open('<%=request.getContextPath()%>/jygdzc/AssetQuery_init.do?ywlx=check&returnValue=true&&cldId='+headId,'','height=600, width=1000, top=100, left=100, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no');
				return false;
			};
	...
	//（处理）新建正文
		function openzhengwen(){
			isNew = false;
			wordTemplate('bank_Template', document.getElementById("myform"),false,true, "盘点管理正文"); 
			//修改按钮名称为“处理正文”
		...
		function viewzhengwen(){
			wordTemplate('bank_Template', document.getElementById("myform"),true,false,"盘点管理正文"); 
		}
		...
		function hechengzhengwen(){
			...
			MergeWordStart('manager_gzlxdht','bank_Template','manager_gzlxdbj' , document.getElementById("myform"), " 盘点管理正文",'hechengHead()','hechengBottom()');
...
<s:hidden  name="head.lcmc" id="lcmc" value="盘点管理" />
...
<!-- ============================================================================ -->
      <br/>
      <div align="center">
        <span class="STYLE7 STYLE1">中国建银投资有限责任公司盘点管理<%@ include file="/pages/rdp4j/workflow/task/workflow_title_include.jsp"%></span>
      </div>
      <br/>
<!-- ==========================工作流信息项======================================= -->
...
<!-- =========================================================================== -->
    ...
    <table class="newtable" id="table"  width="100%" border="0"  align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td class="td_zxy02"><s:textfield name="head.bianhao"  id="bianhao"  readonly="true" cssClass="input"/>
		 </td>
		<td class="td_zxy01">急缓程度：</td>
		<td class="td_zxy02"><r:select list="#{'0':'一般','1':'急','2':'特急'}" id="jhcd" name="head.jhcd" value="%{#request.head.jhcd}"/></td>
	  </tr>	
	  <tr>
		<td class="td_zxy01" width="120">拟稿人：</td>
		<td class="td_zxy02">
		<s:hidden name="head.ngr"  value="%{#request.head.ngr}"  />
		<r:textfield name="head.ngrmc" id="ngr" cssClass="input"  readonly="true"  value="%{#request.head.ngrmc}"/></td>
	  ...
	  <tr>
	   ...
	   <tr>
	    ...
	    <td class="td_zxy02" ><r:select  name="head.pdjg" list="#{'0':'盘亏','1':'盘盈'}" id="check" onclick="clickIndex();"   onchange="change()" value="%{#request.head.pdjg}"/> </td>
...
function addValue(gr){
	...
	$("#fangshi").attr("readonly","readonly");
}
