...
//##联动菜单结束--> 
		 function addTrFromOpenWin(url){
            ...
            function addAsset(){
            var category = document.getElementById('category').options[0].text;
            var itemName = document.getElementById('itemName').options[0].text;
            var itemSpec = document.getElementById('itemSpec').options[0].text;
            var days = document.getElementById('days').value;
            var itemNum = document.getElementById('number').value;
            var itemUnit = document.getElementById('itemUnit').value;
			var serialNumbers = document.getElementById('serialNumbers').value;
            window.returnValue = new Array(category,itemName,itemSpec,itemNum,itemUnit,days,serialNumbers);
            window.close();
            }
      ...
      <tr>
        ...
        <table class="newtable" width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td class="td_form02"><input name="textfield2224" type="text" class="input" /></td>
              <td class="td_form01">实体编号：</td>
              <td class="td_form02"><input name="textfield2223" type="text" class="input" /></td>
            </tr>
            <tr>
              ...
              <td class="td_form01">物品编号：</td>
              <td class="td_form02"><input name="textfield2222" type="text" class="input" /></td>
            </tr>
            <tr>
              <td class="td_form01">管理部门：</td>
              <td class="td_form02"><input name="textfield22242" type="text" class="input" /></td>
              <td class="td_form01">办公地址：</td>
              <td class="td_form02"><input name="textfield222" type="text" class="input" /></td>
            </tr>
            <tr>
...
<script language="javascript"> 
   setup() 
                ...
                <input name="Submit22" type="submit" class="buttonface" value="  查询  " onclick="addAsset()" />
              <input name="Submit3" type="submit" class="buttonface" value="  重置  " /></td>
            </tr>
    </table>
                    <br>
				...
				jQuery("#entity_list").jqGrid({
					datatype: "local",
					colNames:['实体编号','实体中文名称', '实体英文名称','经营分类','管理部门','办公地址','地区','行业','注册日期','注册地址','营业执照号'],
					colModel:[	
						{name:'entityNum',index:'entityNum'},
						{name:'entityName',index:'entityName'},
						{name:'entityEnName',index:'entityEnName',align:"center"},
						{name:'classification',index:'classification'},
						{name:'dept',index:'dept'},
						{name:'adress',index:'adress'},
				...
				var mydata = [ {entityNum:'',entityName:'',entityEnName:'',classification:'',dept:'',adress:'',area:'',industry:'',dateRegistration:'',adressOfRegistration:'',businessLicenseNum:''},
						{entityNum:'',entityName:'',entityEnName:'',classification:'',dept:'',adress:'',area:'',industry:'',dateRegistration:'',adressOfRegistration:'',businessLicenseNum:''},
						{entityNum:'',entityName:'',entityEnName:'',classification:'',dept:'',adress:'',area:'',industry:'',dateRegistration:'',adressOfRegistration:'',businessLicenseNum:''},
						{entityNum:'',entityName:'',entityEnName:'',classification:'',dept:'',adress:'',area:'',industry:'',dateRegistration:'',adressOfRegistration:'',businessLicenseNum:''}];
				for(var i=0;i<=mydata.length;i++)
				    ...
				    $("#t_entity_list").append("<input type='button'  class='buttonface' value='提交' style='height:20px;font-size:-3'/>");
