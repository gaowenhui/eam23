...
<s:hidden name="biaodanid" value="%{#request.biaodanid}" />
	<tr>
		<td class="td_zxy01">是否发布安置公告：</td>
		<td class="td_zxy02" nowrap="nowrap"><s:checkbox name="track.ryazsffbazgg" id="ryazsffbazgg" onclick="clickCheckBox(this)"/>
		<span id="ryazsffbazgg2"></span></td>
		<td class="td_zxy01">&nbsp;</td>
		<td class="td_zxy02">&nbsp;</td>
	</tr>
	<tr  id="ryazsffbazgg1" style="display:none">
		<td class="td_zxy01">安置公告扫描件或截屏：</td>
		<td class="td_zxy02"  colspan="3"><e:filebutton fjlx="anzhigonggao" biaodanId="%{#request.biaodanid}" isview="Y" /></td>
	</tr>
</table>
