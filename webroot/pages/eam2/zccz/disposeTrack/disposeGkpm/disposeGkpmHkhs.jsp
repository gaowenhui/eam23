...
<table  width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="newtable">
	<tr>
		...
		<td class="td_zxy03"  colspan="3"><e:filebutton fjlx="ziliaoyijiao" biaodanId="%{#request.biaodanid}" isview="Y" /></td>
	</tr>
	<tr>
		<td class="td_zxy01">其他附件：</td>
		<td class="td_zxy03"  colspan="3"><e:filebutton fjlx="gkpmqtfj" biaodanId="%{#request.biaodanid}" isview="Y"  /></td>
	</tr>
</table>
<script type="text/javascript">
