...
<html>
  ...
  <body>
	...
	<script>
		...
		tabbar.addTab("a1", "拆迁", "100px");
		tabbar.setHrefMode("iframes-on-demand");
		tabbar.setContentHref("a1","<%=request.getContextPath() %>/zccz/disposeTrack_modifyChildTrack.do?sheettype=${sheettype}&zcIds=${zcIds}&xmIds=${xmIds}&zcCzfs=${zcCzfs}&czgzhj=disposeCqChild&cache="+new Date());
