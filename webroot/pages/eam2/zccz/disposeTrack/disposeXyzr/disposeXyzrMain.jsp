...
<html>
  ...
  <body>
	...
	<script>
		...
		tabbar.addTab("a1", "签订转让协议", "100px");
		tabbar.addTab("a2", "回款回收", "100px");
		tabbar.setHrefMode("iframes-on-demand");
		tabbar.setContentHref("a1","<%=request.getContextPath() %>/zccz/disposeTrack_modifyChildTrack.do?sheettype=${sheettype}&zcIds=${zcIds}&xmIds=${xmIds}&zcCzfs=${zcCzfs}&czgzhj=disposeXyzrQdzrxy&cache="+new Date());
		tabbar.setContentHref("a2","<%=request.getContextPath() %>/zccz/disposeTrack_modifyChildTrack.do?sheettype=${sheettype}&zcIds=${zcIds}&xmIds=${xmIds}&zcCzfs=${zcCzfs}&czgzhj=disposeXyzrHkhs&cache="+new Date());
