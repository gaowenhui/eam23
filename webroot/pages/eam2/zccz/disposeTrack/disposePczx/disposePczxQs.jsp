...
<s:hidden name="biaodanid" value="%{#request.biaodanid}" />
	...
	<tr>
		...
		<td class="td_zxy02"  colspan="3"><e:filebutton fjlx="pczxht" biaodanId="%{#request.biaodanid}" isview="Y" /></td>
	</tr>
	<tr>
		<td class="td_zxy01">审计报告：</td>
		<td class="td_zxy02"  colspan="3"><e:filebutton fjlx="pczxsjbg" biaodanId="%{#request.biaodanid}" isview="Y" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="td_zxy02"  colspan="3"><e:filebutton fjlx="pczxqsfa" biaodanId="%{#request.biaodanid}" isview="Y" /></td>
	</tr>
	<tr>
		<td colspan="4">
			<div>
