...
<body class="easyui-layout">
  ...
  <input type="hidden"  name="czSczskBdxx.bdfs" value="DELETEXM"  id="changeType"/>
  ...
  <input  type="hidden" name="czSczskBdxx.cldId" value="<s:property value='lsb.cldId'/>" id="cldId">
	<table id="table" class="newtable"  width="100%" border="0" cellspacing="0">
      ...
      <tr>
       <td align="center"><input  type="button" value="OK" onclick="saveOrUpdateXmmc();"/><input  type="button" value="关闭"   onclick="history.back();"  onclick="history.back();"/> </td>
      </tr>
  </table>
</form>
</body>
