...
<body class="easyui-layout">
  ...
  <input type="hidden"  name="czSczskBdxx.spzt" value="1"  id="changeType"/>
  ...
  <input  type="hidden" name="czSczskBdxx.cldId" value="<s:property value='lsb.cldId'/>" id="cldId">
	<table id="table" class="newtable"  width="100%" border="0" cellspacing="0">
	 <tr> 
	    <td class="td_zxy01">意见ID：</td>
	     <td class="td_zxy02"><input name="czSczskBdxx.zskid" value="<s:property value='lsb.jtyjbh'/>"/></td>
	  </tr>
	  <tr>  
	    <td class="td_zxy01" align="left">意见名称：</td>
	   <td class="td_zxy02"> <input name="czSczskBdxx.scyj" value="<s:property value='lsb.jtyj'/>"/></td>
      </tr>
	  <tr> 
	    <td class="td_zxy01">原项目名称：</td>
	     <td class="td_zxy02"><input name="czSczskBdxx.beforexm" value="<s:property value='lsb.scxm'/>"/></td>
	  </tr>
	  <tr>  
	    <td class="td_zxy01" align="left">原项目要点：</td>
	   <td class="td_zxy02"> <input name="czSczskBdxx.beforeyd" value="<s:property value='lsb.scyd'/>"/></td>
      </tr>
      <tr> 
	    <td class="td_zxy01">迁移后项目要点：</td>
	     <td class="td_zxy02"><input name="czSczskBdxx.afteryd"/></td>
	  </tr>
	  <tr>  
	    <td class="td_zxy01">迁移后项目名称：</td>
	   <td class="td_zxy02"> 
	     <input name="czSczskBdxx.afterxm"/>
	   </td>
      </tr>
      <tr>
