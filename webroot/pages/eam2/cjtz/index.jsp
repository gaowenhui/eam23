...
<html>
	<head>
		...
		<script>
			...
			function loadUrl(){
				var urlPor = "<%=urlPortal%>";
				if(urlPor != null && urlPor != ""){
				 	var mainWindow = document.getElementById("mainWindow");
				 	mainWindow.src = basePathJs + urlPor;
				} 
			}
	...
	<body class="easyui-layout" onload="loadUrl();">
		<div region="north" title="模块导航" split="true"
			style="height: 110px; background: #B3DFDA;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="385" rowspan="3">
						<img src="resource/ProjectImages/top_r1_c1.jpg" alt="" width="385" height="74" />
					</td>
					<td width="100%" rowspan="3" background="resource/ProjectImages/top_r1_c3.jpg">
						&nbsp;
					</td>
					<td width="61" rowspan="3">
						<img src="resource/ProjectImages/top_r1_c7.jpg" alt="" width="76" height="74" />
					</td>
					<td width="385" background="resource/ProjectImages/index_r1_c6.jpg">
						&nbsp;
					</td>
					<td width="59">
						<img src="resource/ProjectImages/index_r1_c21.jpg" alt="" width="59"
							height="22" />
					</td>
					<td width="74">
						<img src="resource/ProjectImages/index_r1_c24.jpg" alt="" width="73"
							height="22" />
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<img src="resource/ProjectImages/index_r2_c6.jpg" alt="" width="517"
							height="18" />
					</td>
				</tr>
				<tr>
					<td colspan="3" background="resource/ProjectImages/index_r3_c26.jpg"
						bgcolor="#2B8585">
						<img src="resource/ProjectImages/gjtop_r1_c1.jpg" alt="" width="201"
							height="34" /><img src="resource/ProjectImages/top1.jpg" width="316" height="34" />
					</td>
				</tr>
			</table>
		</div>
		...
		<script type="text/javascript">
            ...
            tree.loadXML("<%=basePath %>menuData.jspa?parid=133");
        </script>
		<div align="center" region="center" title="承继投资管理" scrolling="no">
		<!-- 	<iframe id="mainWindow" width=100% style="height: 100%; border: none;" src="/workflow/userTask_findMyTodo.do">
			</iframe>
			 -->
		<%
        	if(urlPortal == null || urlPortal.length() == 0){
        %>
        <iframe id="mainWindow" width=100% style="height:100%;border:none;" src="<s:url value="/workflow/userTask_findMyTodo.do" />"></iframe>
        <%
        	} else {
        %>
		<iframe id="mainWindow" width=100% style="height:100%;border:none;" src="<%=basePath + urlPortal%>"></iframe>
		<%
			}
		%>
		</div>
