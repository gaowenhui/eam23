...
<table id="conditions" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="newtable">
    ...
    <tr>
		...
		<td class="td_zxy02" colspan="3">
			<s:textarea name="body.bz" cssClass="area" rows="4"></s:textarea>
		</td>
    </tr>
	<tr>
		<td class="td_form01" colspan="4">
			<%if(isDisable){ %>
			<input type="button" value="选择基金信息" class="buttonface" onclick="choose();" >
			<%}else{ %>
			<input type="button" value="选择基金信息" class="buttonface" onclick="choose();" >
			<s:submit value="保存" onclick="baocun();" cssClass="buttonface" ></s:submit>
