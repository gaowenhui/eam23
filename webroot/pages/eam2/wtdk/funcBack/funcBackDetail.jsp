...
<table id="conditions" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="newtable">
    ...
    <tr>
        ...
        <td class="td_zxy02"><s:textfield name="body.nhfje" readonly="true" onblur="checkFloat(this);" /></td>
	</tr>
	<tr>
		...
		<td class="td_zxy02"><s:textfield name="body.spje" readonly="true" onblur="checkFloat(this);" /></td>
	</tr>
    <tr>
		<td class="td_zxy01">备注：</td>
		<td class="td_zxy02" colspan="3">
			<s:textarea name="body.bz" cssClass="area" readonly="true" onblur="isString(this);" rows="4"></s:textarea>
		</td>
    </tr>
</table>
</s:form>
