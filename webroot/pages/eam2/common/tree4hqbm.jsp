...
<%
	...
	if("1".equals(deptType)){
		...
		url = "/deptData0.jspa?tid=1&parid=0&include=false";
		id= "1";
	}
%>
<html>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<table>
		...
		<tr>
			<td valign="top">
				<e:itree imagePath="/resource/js/DHtmlXTree/imgs/csh_dhx_skyblue" width="100%" height="100%" multipe="true" threeState="false" 
