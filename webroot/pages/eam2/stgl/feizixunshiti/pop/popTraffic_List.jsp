...
<s:hidden name="sf.stnzcfl" id="stnzcfl" value="10"></s:hidden>
...
<table id="traffic_information" class="newtable" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td class="td_zxy02"><s:textfield name="sf.ljtgjbh" id="ljtgjbh" disabled="true" style="width: 60%;"/></td>
            ...
            <tr>	
              ...
              <td class="td_zxy02"><s:select list="#{'':'请选择',1:'是',2:'否'}" name="sf.lsfdy" id="lsfdy" value="%{#request.sf.lsfdy }"></s:select></td>
              <td class="td_zxy01">&nbsp;</td>
              <td class="td_zxy02">&nbsp;</td>
            </tr>
            ...
            <tr>	
             ...
             <tr>
              ...
              <td colspan="3" class="td_zxy02"><s:textarea name="sf.ljtgjms" id="ljtgjms" rows="3" style="width: 85%;"/></td>
            </tr>
             <tr>
