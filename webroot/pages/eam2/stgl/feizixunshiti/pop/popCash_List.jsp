...
<html>
	<head>
		...
		$(function(){
		   ...
		   <%
		      if(sf!=null&&sf.getHjine()!=null&&!"".equals(sf.getHjine())){
		   %>
		        $("#hjine").val(${sf.hjine}.toFixed(2));
		   <%
		   		}
		   %>
...
<s:hidden name="sf.stnzcfl" id="stnzcfl" value="6"></s:hidden>
<table id="cash_information" class="newtable" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
             <td class="td_zxy01">现金编号(自动生成)：</td>
              ...
              <td class="td_zxy02"><s:textfield name="sf.hjine" id="hjine" value="%{#request.sf.hjine}" onblur="checkFloat(this);"/></td>
            </tr>	
            <tr>
               <td class="td_zxy01">账户： </td>
