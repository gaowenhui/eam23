...
<s:hidden name="sf.stnzcfl" id="stnzcfl" value="8"></s:hidden>
...
<table id="house_information" class="newtable" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
           <tr>
            ...
            <tr>	
              ...
              <td class="td_zxy02"><s:select list="#{'':'请选择',1:'是',2:'否'}" name="sf.ksfdy" id="ksfdy" value="%{#request.sf.ksfdy}"></s:select></td>
