...
<s:hidden name="sf.stnzcfl" id="stnzcfl" value="7"></s:hidden>
...
<table id="land_information" class="newtable" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td class="td_zxy02"><s:textfield name="sf.jtdms" id="jtdms" style="width: 60%;"/></td>
            </tr>
             <tr>
             <td class="td_zxy01">《土地使用权证》：</td>
              <td class="td_zxy02"><s:select list="#{'':'请选择',1:'有',2:'无',3:'下落不明'}" name="sf.jtdsyqz" id="jtdsyqz" value="%{#request.sf.jtdsyqz}"></s:select></td>
            ...
            <tr>	
              ...
              <td class="td_zxy02"><s:select list="#{'':'请选择',1:'是',2:'否'}" name="sf.jtdsfdy" id="jtdsfdy" value="%{#request.sf.jtdsfdy}"></s:select></td>
