		...
		$(function(){
			$("#myform").ajaxForm({
			   	...
			   	if(document.getElementById("ndwtzbh").value == "" || document.getElementById("ndwtzbh").value == null){
			   		...
			   		document.getElementById("ndwtzbh").value = reStr.result[0].ndwtzbh;
			   	}
...
<s:hidden name="sf.stnzcfl" id="pop" value="11"></s:hidden>
...
<table id="invest_information" class="newtable" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
             <tr>
              ...
              <td class="td_zxy02"><s:textfield name="sf.ndwtzbh" id="ndwtzbh" readonly="true" style="width: 60%;"/></td>
             <td class="td_zxy01">
            ...
            <tr>
              ...
              <td class="td_zxy02"><s:textfield name="sf.ntze" id="ntze" style="width: 60%;" onblur="checkFloat(this);"/></td>
           	  <td class="td_zxy01">投资方式：</td>
              <td class="td_zxy02"><s:textfield name="sf.ntzfs" id="ntzfs" style="width: 60%;"/></td>
            </tr>	
             <tr>
              <td class="td_zxy01">投资情况描述：</td>
              <td colspan="3" class="td_zxy02"><s:textarea name="sf.ntzqkms" id="ntzqkms" rows="3" style="width: 85%;"></s:textarea></td>
            </tr>
            <tr>
