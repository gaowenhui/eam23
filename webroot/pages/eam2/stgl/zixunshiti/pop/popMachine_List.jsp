...
//			var returnValue = window.showModalDialog('weihu_newPersonList.do?id='+id+'&fslx='+1, window, _g_privateDialogFeatures);
		...
		function addAss(){
			...
			var msbbh = document.getElementById("msbbh").value;
			if(msbbh.length == 0){
				alert("请先填写资产信息！")
			}else{
...
<s:hidden name="sf.stnzcfl" id="pop" value="9"></s:hidden>
...
<table id="machine_information" class="newtable" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
             <tr>
              ...
              <td class="td_zxy02"><s:textfield name="sf.msbbh" id="msbbh" disabled="true" style="width: 60%;"/></td>
            ...
            <tr>
              ...
              <font color="#FF0000"><strong>*</strong></font>  
             	 名称：</td>
              <td class="td_zxy02"><s:textfield name="sf.msbmc" id="msbmc" style="width: 60%;"/></td>
              <td class="td_zxy01">存放何处： </td>
              <td class="td_zxy02"><s:textfield name="sf.msbcfwz" id="msbcfwz" style="width: 60%;"/></td>
            </tr>	
            <tr>
              <td class="td_zxy01">权属：</td>
              <td class="td_zxy02"><s:textfield name="sf.msbqs" id="msbqs" style="width: 60%;"/></td>
             <td class="td_zxy01">实际占有人：</td>
              <td class="td_zxy02"><s:textfield name="sf.msbsjzyr" id="msbsjzyr" style="width: 60%;" /></td>
            </tr>
            <tr>	
              <td class="td_zxy01">机器是否抵押：</td>
              <td class="td_zxy02"><s:select list="#{'':'请选择',1:'是',0:'否'}" name="sf.msbsfdy" id="msbsfdy" value="%{#request.sf.msbsfdy}"></s:select></td>
              <td class="td_zxy01">&nbsp;</td>
              <td class="td_zxy02">&nbsp;</td>
            </tr>
             <tr>
              <td class="td_zxy01">抵押情况介绍：</td>
              <td colspan="3" class="td_zxy02"><s:textarea name="sf.msbdyjs" id="msbdyjs" rows="3" style="width: 85%;"/></td>
            </tr>
             <tr>
              <td class="td_zxy01">机器设备描述：</td>
              <td colspan="3" class="td_zxy02"><s:textarea name="sf.msbms" id="msbms" rows="3" style="width: 85%;"></s:textarea></td>
            </tr>
             <tr>
