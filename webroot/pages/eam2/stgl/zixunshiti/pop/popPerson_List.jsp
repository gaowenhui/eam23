...
<table id="common_tableWidth" class="newtable" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td class="td_zxy02"><s:radio list="#{1:'男',2:'女'}"   id="fxingbie" name="sf.fxingbie"></s:radio></td>
            ...
            <tr>
              ...
              <td class="td_zxy02"><s:radio list="#{1:'未婚',2:'已婚'}"    name="sf.fcHyzk" id="fcHyzk"></s:radio></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="td_zxy02"><s:textfield name="sf.fcsny" id="fcsny" /></td>
