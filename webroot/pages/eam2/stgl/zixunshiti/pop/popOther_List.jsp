...
<s:hidden name="sf.stnzcfl" id="pop" value="12"></s:hidden>
...
<table id="otherasset_information" class="newtable" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
            <tr>
              <td class="td_zxy01">其他资产编号(自动生成)：</td>
              <td class="td_zxy02"><s:textfield name="sf.pqtzcbh" id="pqtzcbh" readonly="true" style="width: 60%;"/></td>
            ...
            <tr>	
              ...
              <td class="td_zxy02"><s:select list="#{'':'请选择',1:'是',0:'否'}" name="sf.pqtzcsfdy" id="pqtzcsfdy" value="%{#request.sf.pqtzcsfdy }"></s:select></td>
              <td class="td_zxy01">&nbsp;</td>
              <td class="td_zxy02">&nbsp;</td>
            </tr>
            <tr>
             ...
             <tr>
              ...
              <td colspan="3" class="td_zxy02"><s:textarea name="sf.pzcms" id="pzcms" rows="3" style="width: 85%;"/></td>
            </tr>
             <tr>
