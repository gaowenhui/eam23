...
#idMenu2_6 a {
	...
	<body class="body1">
		<form name="myForm" method="post" action="<%=request.getContextPath()%>/workflow/workflow_completeTask.do">
			<input type="hidden" name="nextTodoUrl" value="workflow/workflow_todo.do">
			<input type="hidden" name="didUrl" value="did/userDid_findDids.do">
