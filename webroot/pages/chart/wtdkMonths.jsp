...
<SCRIPT language=JavaScript type=text/JavaScript>
			 function query(){
					      ...
					      var url="<%=basePath%>char/CharAction_wtdkCountByMonths.do?year="+year+"&address=<%=address%>";
		   ...
		   //按年统计
			...
			//统计近期
		      ...
		      var url="<%=basePath%>char/CharAction_wtdkCountByLastMonth.do?"+"address=<%=address%>";
              window.location.href(url); 
		     }
</SCRIPT>
<base href="<%=basePath%>" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><%=cityName%>委托贷款余额统计</title>
    ...
    <div id="lightbox">
	       <div class="chart_frame">
			 ...
			 <cewolf:chart id="line" title="" 
	           type="line" xaxislabel="月份" yaxislabel="委托贷款余额(万元)"> 
		      <cewolf:data>      
		       <cewolf:producer id="wtdkMonths"/> 
		      </cewolf:data>
