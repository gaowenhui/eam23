...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><%=cityName%>省经营性固定资产信息统计-合同租金收入</title>
		 ...
		 function query(){
		    ...
		    //  var type = document.getElementById("type").value;
			 ...
			 function queryByYears(){
		      var url="<%=basePath%>char/CharAction_htzjCountByYear.do?&address=<%=address%>&type=<%=type%>";
              window.location.href(url); 
              //window.parent.resizeFancybox();
			 }
        </script>
	...
	<body>
       <div id="lightbox">
       <h1><%=cityName%>近期经营性固定资产信息统计-合同租金收入</h1>
		...
		<cewolf:chart id="verticalBar" title="" type="verticalBar3D" xaxislabel="时间" yaxislabel="合同租金收入(万元)">
			<cewolf:data>
				<cewolf:producer id="htzjLastMonths" />
			</cewolf:data>
