...
<title>资产处置统计</title>
	...
	function showWin(obj)
			{
				$.post("<%=basePath%>char/CharAction_queryZcczData.do",{
						"address" : $(obj).attr("name")
					},function(data){
						//$("#fancybox-outer").css("background","");
						var dataArr = data.split("|*|");
						$("#cityName").html(dataArr[0]);
						$("#hkzsrje").html(dataArr[1]);
						$("#fy").html(dataArr[2]);
						$("#hkzsrje1").html(dataArr[3]);
						$("#fy1").html(dataArr[4]);
						$("#hkzsrje2").html(dataArr[5]);
						$("#fy2").html(dataArr[6]);
     ...
     <div class="wrap">
          ...
          <div class="outline">
               <div class="tab">
                    ...
                    <li class="now"><a href="<%=basePath%>tj/MapTjAction_zqCzCount.do">资产处置</a></li>
                    <li class="left"></li>
   ...
   <div id="test" style="position:absolute;display:none;">
	   <div class="dialog_s">
	     ...
	     <div class="btm_bg">
	        ...
	        <h3>未执行</h3>
	        <p class="heights"><span class="item">收入</span> <span class="datas" id="hkzsrje"></span>万元</p>
	        <p class="heights"><span class="item">费用</span> <span class="datas" id="fy"></span>万元</p>
	        <h3>执行中</h3>
	        <p class="heights"><span class="item">收入</span> <span class="datas" id="hkzsrje1"></span>万元</p>
	        <p class="heights"><span class="item">费用</span> <span class="datas" id="fy1"></span>万元</p>
	        <h3>已结案</h3>
	        <p class="heights"><span class="item">收入</span> <span class="datas" id="hkzsrje2"></span>万元</p>
	        <p class="heights"><span class="item">费用</span> <span class="datas" id="fy2"></span>万元</p>
