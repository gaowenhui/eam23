...
<title>委托贷款统计</title>
	...
	<script type="text/javascript">
			function showWin(obj)"C:/Documents and Settings/ibm/Application Data/Tencent/QQ/Temp/)QN1UH78VKP2T7)IA]ZM(FW.gif"
			{
				$.post("<%=basePath%>char/CharAction_queryDxwddkData.do",{
						"address" : $(obj).attr("name")
					},function(data){
						$("#fancybox-outer").css("background","");
						var dataArr = data.split("|*|");
						$("#cityName").html(dataArr[0]);
						$("#dxwtye2").html(dataArr[1]);
					 }
				  );
			  //	$("#fancybox-outer").css("left",getElementViewLeft(obj)-370);
				//$("#fancybox-outer").css("top",getElementViewTop(obj)-266);
   ...
   <div id="test" style="position:absolute;display:none;">
	   <div class="dialog_s">
	     ...
	     <div class="btm_bg">
	        ...
	        <p><span class="item">担险委托贷款余额</span> <span class="datas_first" id="dxwtye2"></span>万元</p>
	     </div>
	   </div>
   </div>
</div>
