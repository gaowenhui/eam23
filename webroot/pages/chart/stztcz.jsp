...
<title>资产处置信息统计-实体整体处置</title>
	...
	<script type="text/javascript">
			...
			{
				$.post("<%=basePath%>char/CharAction_queryStztczData.do",{
						"address" : $(obj).attr("name")
					},function(data){
						$("#fancybox-outer").css("background","");
						var dataArr = data.split("|*|");
						$("#cityName").html(dataArr[0]);
						$("#stztczsrSpan").html(dataArr[1]);
						$("#stczfySpan").html(dataArr[2]);
						$("#stztczsrSpan1").html(dataArr[3]);
						$("#stczfySpan1").html(dataArr[4]);
						$("#stztczsrSpan2").html(dataArr[5]);
						$("#stczfySpan2").html(dataArr[6]);
						/**$.fancybox($("#test").html(),{
     ...
     <div class="wrap">
          ...
          <div class="outline">
               <div class="tab">
                    ...
                    <li class="now"><a href="<%=basePath%>tj/MapTjAction_stztczCount.do">实体整体处置</a></li>
                    <li class="left"></li>
                    <li class="right"><a href="<%=basePath%>tj/MapTjAction_stryazCount.do">实体人员安置</a></li>
                    </ul>
   ...
   <div id="test"  style="position:absolute;display:none;">
	   <div class="dialog">
	     ...
	     <div class="btm_bg">
	        ...
	        <h3>未执行</h3>
	        <p class="heights"><span class="item">实体整体处置</span> <span class="datas" id="stztczsrSpan"></span>万元</p>
	        <p class="heights"><span class="item">实体处置费用</span> <span class="datas" id="stczfySpan"></span>万元</p>
	        <h3>执行中</h3>
	        <p class="heights"><span class="item">实体整体处置</span> <span class="datas" id="stztczsrSpan1"></span>万元</p>
	        <p class="heights"><span class="item">实体处置费用</span> <span class="datas" id="stczfySpan1"></span>万元</p>
	        <h3>已结案</h3>
	        <p class="heights"><span class="item">实体整体处置</span> <span class="datas" id="stztczsrSpan2"></span>万元</p>
	        <p class="heights"><span class="item">实体处置费用</span> <span class="datas" id="stczfySpan2"></span>万元</p>
	        <div class="btmdiv">&nbsp;</div>
	     </div>
	   </div>
   </div>
</div>
