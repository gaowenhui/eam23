...
<tr>
    <td align='center' >
      <br>
	   ...
	   <input type='button' value='保存'  class='text1' onclick='draft()' class='text1' align='center'>
	...
	<tr>	
	  ...
	  <tr> 
	   ...
	   <tr> 
	    ...
	    <td class="td_form02" colspan="5"><textarea name="content" cols="150" rows="4"></textarea></td>
	  </tr> 
