...
$.extend(Timepicker.prototype, {
	...
	_newInst: function($input, o) {
		...
		tp_inst._defaults = $.extend({}, this._defaults, inlineSettings, o, {
			...
			onClose: function(dateText, dp_inst) {
				if('onCloseTimePicker' in window){
		            if(onCloseTimePicker instanceof Function){
		                var result = onCloseTimePicker(dateText);
		                if(!result) return;
		            }
		        }
	...
	_injectTimePicker: function() {
		$("#ui-datepicker-div").css("height","auto");
		$("#ui-datepicker-div").css("width","200");
