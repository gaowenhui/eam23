...
if ($.fn.validatebox){
	$.fn.validatebox.defaults.missingMessage = 'Dette felt er pÃ¥krÃ¦vet.';
	...
	$.fn.validatebox.defaults.rules.length.message = 'Angiv en vÃ¦rdi mellem {0} og {1}.';
}
if ($.fn.numberbox){
	$.fn.numberbox.defaults.missingMessage = 'Dette felt er pÃ¥krÃ¦vet.';
}
if ($.fn.combobox){
	$.fn.combobox.defaults.missingMessage = 'Dette felt er pÃ¥krÃ¦vet.';
}
if ($.fn.combotree){
	$.fn.combotree.defaults.missingMessage = 'Dette felt er pÃ¥krÃ¦vet.';
}
if ($.fn.calendar){
...
if ($.fn.datebox){
	...
	$.fn.datebox.defaults.missingMessage = 'Dette felt er pÃ¥krÃ¦vet.';
}
