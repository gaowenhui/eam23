...
if ($.fn.datagrid){
	$.fn.datagrid.defaults.loadMsg = "Traitement, s'il vous pląt patienter ...";
}
if ($.messager){
...
if ($.fn.validatebox){
	...
	$.fn.validatebox.defaults.rules.email.message = "S'il vous pląt entrer une adresse email valide.";
	$.fn.validatebox.defaults.rules.url.message = "S'il vous pląt entrer une URL valide.";
	$.fn.validatebox.defaults.rules.length.message = "S'il vous pląt entrez une valeur comprise entre {0} et {1}.";
}
if ($.fn.numberbox){
