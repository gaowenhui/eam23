 ...
 * @version V1.0
 */
public class CEMLegalRepChangeHeadAction2 extends CommonAction{
	...
	public String saveHead() {
		...
		if(StringUtils.isNotEmpty(taskId)){
			...
			workflowutil.putVariables(taskId, "codeType", "stgl_frdbbg");
	...
	public String createNum(){
		...
		if(bianhao == null||bianhao.length() == 0){
			bianhao = iCodeGenerator.generateCurrentCode("stgl_frdbbg", head.getNgbm(), head.getNgbmmc());
