...
public class HtqsWorkflowAction extends CommonWorkflowAction{
	...
	public String draftCommit(){
		...
		head.setZhuangtai(JygdzcCommon.CONTRACT_SPZT_SPZ);
	...
	public String saveDraft(){
		...
		if(StringUtils.equals("拟稿",this.taskName)){
			...
			head.setZhuangtai(JygdzcCommon.CONTRACT_SPZT_WSP);
			contractBSImpl.update(head);
		}
		return result;
	}
