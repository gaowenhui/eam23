package com.tansun.eam2.ssgl.service;
...
public interface ISsglBS {
	...
	void saveSSchangeInfo(SsBaseinfo ssBaseinfo_old, SsBaseinfo ssBaseinfo_new,String opType);

	void saveSSchangePro(SsProc ssproc_old, SsProc ssproc_new,String opType,String sheet);
	/**
	 * 根据资产临时表ID 找到相应诉讼信息
	 * @param zcId
	 * @param paginator
