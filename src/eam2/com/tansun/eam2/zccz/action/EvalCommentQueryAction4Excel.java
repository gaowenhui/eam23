...
public class EvalCommentQueryAction4Excel extends CommonAction implements IExport {
	...
	public String exportexcel() throws Exception {
		...
		List<EvalVO4> list = evalQueryUCCImpl.queryCzPgscZskwhCld4(paginator, evalVO3);
