 ...
 *
 */
public class STHGSCEventListener implements EventListener{
	/**
	 * 
	 */
	private static final long serialVersionUID = 8533895869944233749L;
	...
	public void notify(EventListenerExecution arg0) throws Exception {
		...
		assetDealWfBS.sendMsg(sender, msg,cldId,"/eam2/zcczWorkflow/zcczWorkflow_did.do","taskId="+taskId+"&headId="+cldId,messageBS);
		if(logger.isDebugEnabled()){
			logger.debug("_____________________STNGTJEventListener Started_________");
		}
