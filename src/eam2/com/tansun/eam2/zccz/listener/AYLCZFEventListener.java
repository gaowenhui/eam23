 ...
 *
 */
public class AYLCZFEventListener implements EventListener{
	
	private CzStcztzWfBS wfBS;
	
	public static ApplicationContext ctx;

	public AYLCZFEventListener(){
	...
	public void notify(EventListenerExecution arg0) throws Exception {
		...
		wfBS.updateStatuForDropStayaz(cldId);
		wfBS.releaseStayazBianhao(cldId);//释放编号
