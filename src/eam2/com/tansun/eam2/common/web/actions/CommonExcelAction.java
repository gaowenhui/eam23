 ...
 * @date 2011-03-29
 */
public class CommonExcelAction extends CommonAction {
	...
	public String export() {
		...
		try {
			...
			InputStream in = new ByteArrayInputStream(download);
            while (in.available() > 0) {
                int len = in.read(download);
                ouputStream.write(download, 0, len);
                ouputStream.flush();
            }
			ouputStream.close();
		} catch (Exception e) {
