...
/**
 * CrtDccSaacnamt entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class CrtDccSaacnamt extends com.tansun.rdp4j.common.web.vo.CommonBO
		implements java.io.Serializable {

	// Fields

	private CrtDccSaacnamtId id;
	...
	/** default constructor */
	public CrtDccSaacnamt() {
	}

	/** minimal constructor */
	public CrtDccSaacnamt(CrtDccSaacnamtId id) {
		this.id = id;
	}

	/** full constructor */
	public CrtDccSaacnamt(CrtDccSaacnamtId id, Long saamtLl,
	...
	public CrtDccSaacnamtId getId() {
		return this.id;
	}

	public void setId(CrtDccSaacnamtId id) {
		this.id = id;
	}
