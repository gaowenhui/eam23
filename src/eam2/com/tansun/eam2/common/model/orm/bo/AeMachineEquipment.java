...
/**
 * AeMachineEquipment entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class AeMachineEquipment extends com.tansun.rdp4j.common.web.vo.CommonBO  implements java.io.Serializable {
	...
	/** default constructor */
	public AeMachineEquipment() {
	}

	/** full constructor */
	public AeMachineEquipment(Date lrsj, String zcId, String kpbh,
			Long shuliang, String cfdd, String sfzc, String sfxz, String sftt,
			String sfdbf, String jhzy, String qtdsfzy, String wczy,
			String xssyz, String xssyzdz, String wczyqksm, String sfpy,
			String pyyy, String sfpk, String pkyy, String tybs, String tybsyy,
			String sfycz, String zyrfddz, String sfyzlht, String zlhtxh,
			Date zlhtqsrq, Long zlq, Double yzjjg, String czsj, Double yuanzhi,
			Double jinge, String czht, String htbh, Double czsr, Double czfy,
			Double czsy, String czhsfjsrz, String wrzyy, String sfjf,
			String sfdy, String sfss, Date gzrq, Date qyrq, Double zmyz,
			Double zmjz, Double zmjzzb, Double zmje, String zcgljy,
			String beizhu) {
		this.lrsj = lrsj;
		this.zcId = zcId;
		this.kpbh = kpbh;
	...
	public Double getZmjzzb() {
		return this.zmjzzb;
	}

	public void setZmjzzb(Double zmjzzb) {
		this.zmjzzb = zmjzzb;
	}
