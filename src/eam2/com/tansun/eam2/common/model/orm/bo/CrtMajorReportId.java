...
/**
 * CrtMajorReportId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class CrtMajorReportId extends com.tansun.rdp4j.common.web.vo.CommonBO
	...
	/** default constructor */
	public CrtMajorReportId() {
	}

	/** full constructor */
	public CrtMajorReportId(Date dataDate, String glOpunCod, String glLgNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrtMajorReportId))
			return false;
		CrtMajorReportId castOther = (CrtMajorReportId) other;
