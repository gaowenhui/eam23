...
/**
 * CrtDccLnlnslns entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class CrtDccLnlnslns extends com.tansun.rdp4j.common.web.vo.CommonBO
	...
	/** default constructor */
	public CrtDccLnlnslns() {
	}

	/** minimal constructor */
	public CrtDccLnlnslns(String lnLnAcctNo) {
		this.lnLnAcctNo = lnLnAcctNo;
	}

	/** full constructor */
	public CrtDccLnlnslns(String lnLnAcctNo, String lnlnsDbTimestamp,
			...
			String filler, String comAccountNo, String loanNorLgNo) {
		this.lnLnAcctNo = lnLnAcctNo;
